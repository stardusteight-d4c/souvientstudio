export const navbarStyles = {
  ...
  desktopListItem: `md:effect-underline relative w-fit cursor-pointer duration-500 font-medium list-none`,
  ...
  mobileListItem: `md:effect-underline text-3xl cursor-pointer font-medium list-none`,
}
