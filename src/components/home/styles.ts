export const heroStyles = {
  ...
  linkButton: `hover:scale-105 uppercase text-white z-50 relative bg-pink transition-all duration-300 rounded-full w-fit block py-3 px-8 active:scale-100 outline-none mx-auto mt-[40px]`,
}
...
export const behanceStyles = {
  ...
  handleLinkButton: (isVisible: boolean) => {
    ...
    } block mt-[40px] w-fit bg-pink py-3 px-6 mx-auto text-white font-medium rounded-full`
  },
}
